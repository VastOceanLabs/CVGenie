...
import { 
  ...
  CheckCircle, Filter, Eye, ThumbsUp, FileText, Briefcase, 
  GraduationCap, Award, Users, Share2, Bookmark, ChevronRight
} from 'lucide-react';
...
const categories = [
  ...
  { id: 'resume-writing', name: 'Resume Writing', count: 2, icon: FileText },
  { id: 'ats-optimization', name: 'ATS Tips', count: 1, icon: Target },
  { id: 'cover-letters', name: 'Cover Letters', count: 1, icon: Award },
  { id: 'interview-tips', name: 'Interview Tips', count: 1, icon: Users },
  { id: 'remote-work', name: 'Remote Work', count: 1, icon: Briefcase }
];

// Featured topics for quick navigation
const featuredTopics = [
  ...
  },
  {
    ...
    description: 'Tailored advice for your field',
    articleCount: 12,
    icon: Briefcase,
          ...
          <div className="bg-white rounded-xl max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <AuthorAvatar author={selectedArticle.author} size="lg" />
                    <div>
