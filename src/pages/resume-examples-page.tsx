...
const industryExamples = {
    ...
    examples: [
      {
        ...
        data: {
          personalInfo: {
            ...
            website: 'alexrod.dev',
            summary: 'Experienced full-stack developer with 6+ years building scalable web applications using React, Node.js, and cloud technologies. Led development teams of 5+ engineers and delivered 20+ successful projects. Expert in microservices architecture and DevOps practices, resulting in 40% improved deployment efficiency.',
      ...
      },
      {
        ...
        data: {
          personalInfo: {
            ...
            summary: 'Recent Computer Science graduate with strong programming fundamentals and hands-on experience through internships and personal projects. Proficient in Java, Python, and web development technologies. Built 5+ full-stack applications and contributed to open-source projects with 100+ GitHub stars.',
    ...
    examples: [
      {
        ...
        data: {
          personalInfo: {
            ...
            phone: '(555) 456-7890',
            location: 'Chicago, IL',
            summary: 'Dedicated ICU Registered Nurse with 4+ years of critical care experience. Specialized in advanced cardiac monitoring, ventilator management, and emergency response. Maintained 98% patient satisfaction scores while caring for 12+ patients per shift. ACLS and PALS certified with strong collaboration skills.',
    ...
    examples: [
      {
        ...
        data: {
          personalInfo: {
            ...
            phone: '(555) 321-0987',
            location: 'Denver, CO',
            summary: 'Licensed Journeyman Electrician with 5+ years of commercial and residential electrical experience. Specialized in electrical installations, troubleshooting, and code compliance. Completed 200+ projects with zero safety incidents. OSHA 30 certified with expertise in renewable energy systems.',
    ...
    examples: [
      {
        ...
        data: {
          personalInfo: {
            ...
            summary: 'Results-driven Digital Marketing Manager with 4+ years driving brand growth and customer acquisition. Managed $500K+ annual budgets and delivered 150% ROI through data-driven campaigns. Expert in Google Ads, Facebook advertising, and marketing automation, resulting in 40% increase in qualified leads.',
  ...
  'project-manager': {
    ...
    icon: Briefcase,
    description: 'Management-focused resume examples highlighting leadership, planning, and successful project delivery.',
    searchVolume: '25K+ monthly searches',
    avgSalary: '$90,000',
    growthRate: '+11%',
    color: 'indigo',
    keywords: ['project manager resume', 'PMP resume', 'agile project manager resume'],
    examples: [
      {
        ...
        popularity: 90,
        downloads: 7650,
        features: ['PMP certified', 'Agile/Scrum expertise', 'Budget management'],
        preview: '/examples/project-manager/senior-pm.jpg',
        atsScore: 95,
        data: {
          personalInfo: {
            firstName: 'David',
            ...
            phone: '(555) 789-0123',
            location: 'Seattle, WA',
            summary: 'PMP-certified Senior Project Manager with 6+ years leading cross-functional teams and delivering complex projects on time and under budget. Managed $2M+ portfolios with 95% success rate. Expert in Agile methodologies, stakeholder management, and risk mitigation, resulting in 25% improved team efficiency.',
  ...
  'sales-representative': {
    ...
    icon: TrendingUp,
    description: 'Sales-focused resume examples showcasing quota achievements, relationship building, and revenue growth.',
    searchVolume: '18K+ monthly searches',
    avgSalary: '$72,000',
    growthRate: '+5%',
    color: 'red',
    keywords: ['sales representative resume', 'sales resume examples', 'account executive resume'],
    examples: [
      {
        id: 'enterprise-sales-rep',
        ...
        popularity: 87,
        downloads: 6840,
        features: ['Quota overachievement', 'Enterprise accounts', 'Relationship building'],
        preview: '/examples/sales/enterprise-rep.jpg',
        atsScore: 91,
        data: {
          personalInfo: {
            firstName: 'Jessica',
            ...
            phone: '(555) 567-8901',
            location: 'Miami, FL',
            summary: 'High-performing Enterprise Sales Representative with 5+ years exceeding quotas and building lasting client relationships. Consistently achieved 120%+ of sales targets, generating $2M+ in annual revenue. Expert in consultative selling, account management, and CRM optimization, resulting in 95% client retention rate.',
            jobTitle: 'Enterprise Sales Representative',
            yearsExperience: '5'
          }
        }
      }
...
export default function ResumeExamples() {
  ...
  const getFilteredExamples = () => {
    ...
    return allExamples.filter(example => {
      ...
      const matchesSalary = filters.salary === 'all' || (() => {
        const salaryRange = example.salary;
  ...
  const handlePreview = (example) => {
    // Navigate to a preview route instead of blocking alert
  ...
  const handleUseTemplate = (example) => {
    ...
    // In real implementation, this would pass the example data to the builder
    navigate('/builder', { 
      state: { 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            {/* Industry Overview (when specific industry selected) */}
...
}) && parseInt(salaryRange.replace(/[^\d]/g, '')) < 50;
          case '$50K-$75K':
            const amount = parseInt(salaryRange.replace(/[^\d]/g, ''));
            return amount >= 50 && amount < 75;
          case '$75K-$100K':
            const amount2 = parseInt(salaryRange.replace(/[^\d]/g, ''));
            return amount2 >= 75 && amount2 < 100;
          case '$100K+':
            return parseInt(salaryRange.replace(/[^\d]/g, '')) >= 100;
          default:
            return true;
        }
      })();
  ...
  // Handle preview
  const handlePreview = (example) => {
    // For now, just show an alert - in the real app this would open a modal
    alert(`Preview for ${example.title} - This would open a detailed preview modal`);
  };
