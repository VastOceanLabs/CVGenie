...
import { ArrowLeft, ArrowRight, User, Mail, Phone, MapPin, Globe, Linkedin, Github, BookOpen, Lightbulb, Sparkles, Target, AlertCircle, CheckCircle, Eye, Users, FileText, Briefcase, Zap } from 'lucide-react';
...
export default function EnhancedPersonalInfoSection({ 
  ...
  const [atsAnalysis, setAtsAnalysis] = useState({ score: 0, keywords: [], missing: [] });
  ...
  const validatePersonalInfo = () => {
    ...
    if (!personalInfo.summary?.trim()) errors.summary = 'Professional summary is required';
  ...
  const generateSummaryFromTemplate = (templateIndex = 0) => {
