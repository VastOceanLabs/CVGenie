...
export type ToolCategory = 'marketing-automation' | 'enterprise-automation' | 'advertising' | 'social-advertising' | 'analytics' | 'design' | 'email-marketing' | 'seo-tools' | 'social-media';
...
export interface EnhancedTool extends EnhancedSkill {
...
export const marketingManagerIndustry = {
  ...
  salaryInsights: {
    byLocation: {
      'San Francisco, CA': { entry: 55000, mid: 95000, senior: 150000 } as LocationSalary,
      'New York, NY': { entry: 52000, mid: 88000, senior: 140000 } as LocationSalary,
      'Seattle, WA': { entry: 48000, mid: 82000, senior: 130000 } as LocationSalary,
      'Austin, TX': { entry: 45000, mid: 75000, senior: 115000 } as LocationSalary,
      'Chicago, IL': { entry: 43000, mid: 72000, senior: 110000 } as LocationSalary,
      'Denver, CO': { entry: 42000, mid: 70000, senior: 108000 } as LocationSalary,
      'Atlanta, GA': { entry: 40000, mid: 68000, senior: 105000 } as LocationSalary,
      'Remote': { entry: 41000, mid: 71000, senior: 112000 } as LocationSalary
    },
    topPayingSkills: [
