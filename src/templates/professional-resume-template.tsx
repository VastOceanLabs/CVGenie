          ...
          <div className="relative px-8 py-8 bg-gradient-to-r from-gray-50 to-white">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              ...
              <address className="lg:ml-8 space-y-2 text-gray-700 not-italic">
                <div className="flex items-center space-x-2">
                  {config.showIcons && <Mail className="w-4 h-4 flex-shrink-0" style={{ color: getColor(template.colors.primary) }} aria-hidden="true" />}
                ...
                <div className="flex items-center space-x-2">
                  {config.showIcons && <Phone className="w-4 h-4 flex-shrink-0" style={{ color: getColor(template.colors.primary) }} aria-hidden="true" />}
                  <span className="text-sm lg:text-base">{resumeData.personalInfo.phone}</span>
                </div>
                
                {resumeData.personalInfo.location && (
                  <div className="flex items-center space-x-2">
                    {config.showIcons && <MapPin className="w-4 h-4 flex-shrink-0" style={{ color: getColor(template.colors.primary) }} aria-hidden="true" />}
                    <span className="text-sm lg:text-base">{resumeData.personalInfo.location}</span>
                  </div>
                )}
                
                {resumeData.personalInfo.linkedin && (
                  <div className="flex items-center space-x-2">
                    {config.showIcons && <Linkedin className="w-4 h-4 flex-shrink-0" style={{ color: getColor(template.colors.primary) }} aria-hidden="true" />}
                ...
                {resumeData.personalInfo.website && (
                  <div className="flex items-center space-x-2">
                    {config.showIcons && <Globe className="w-4 h-4 flex-shrink-0" style={{ color: getColor(template.colors.primary) }} aria-hidden="true" />}
                    <a href={`https://${resumeData.personalInfo.website}`} 
                       className="hover:underline text-sm lg:text-base">
                      {resumeData.personalInfo.website}
                    </a>
                  </div>
